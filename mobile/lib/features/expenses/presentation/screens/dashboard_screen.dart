...
class DashboardScreen extends StatelessWidget {
  ...
  Widget _buildBillAlertBanner(
    ...
    if (overdueBills.isNotEmpty) {
      ...
      subtitle = 'Nominal: ${currencyFormatter.format(bill.amount)} • Siapkan pembayaran hari ini';
      ...
      subtitle = 'Jatuh tempo dlm $days hari (${currencyFormatter.format(bill.amount)})';
